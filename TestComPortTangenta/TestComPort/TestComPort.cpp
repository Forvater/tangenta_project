...
// TestComPort.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTestComPortApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()



// создание CTestComPortApp

CTestComPortApp::CTestComPortApp()
{
...
// Единственный объект CTestComPortApp

CTestComPortApp theApp;


// инициализация CTestComPortApp

BOOL CTestComPortApp::InitInstance()
{
